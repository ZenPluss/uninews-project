    ...
    <footer className="glass-effect mt-12">
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            <Link href="/" className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold font-orbitron">AniNews</span>
            </Link>
            <p className="text-gray-400 text-sm">
              Portal berita terpercaya untuk penggemar anime dan manga Indonesia.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              <li><Link href="#" className="hover:text-white transition-colors">Anime</Link></li>
              <li><Link href="#" className="hover:text-white transition-colors">Manga</Link></li>
              <li><Link href="#" className="hover:text-white transition-colors">Film</Link></li>
              <li><Link href="#" className="hover:text-white transition-colors">Game</Link></li>
              <li><Link href="#" className="hover:text-white transition-colors">Event</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center text-sm text-gray-400">
          <p>&copy; 2024 AniNews. All rights reserved. Made with ❤️ for anime lovers</p>
        </div>
      </div>
    </footer>
  )
